...
class IndustryData {
  Locale locale;
  IndustryData(this.locale);

  /// Returns complete list of industry data
  List<Map> getAll() {
    if (locale.languageCode == 'de') {
      return _industriesDE;
    } else if (locale.languageCode == 'en') {
      return _industriesEN;
    }
    return List<Map>();
  }

  /// Returns the branches from an industry
  getBranchByIndustry(String branch) {
    if (locale.languageCode == 'de') {
      return _industriesDE
  ...
  /// Returns the branch key from the industry
  getBranchKeyByIndustry(String branchKey) {
    if (locale.languageCode == 'de') {
      return _industriesDE
          .map((map) => IndustryModel.fromJson(map))
...
//      .toString();
  ...
  List<String> getIndustryByBranchKey(String key) {
    if (locale.languageCode == 'de') {
      return _industriesDE
          .map((map) => IndustryModel.fromJson(map))
...
//  List<String> getIndustries() => _industriesDE
//      .map((map) => IndustryModel.fromJson(map))
//      .map((item) => item.branch)
//      .toList();
  ...
  /// German version of the industries list
  List _industriesDE = [
    {
  ...
  /// English version of the industries list
  List _industriesEN = [
    {
      'branch': 'Agriculture, forestry, fishing',
      'key': 'A',
      'trade': [
        '01 Agriculture, hunting and related activities',
        '02 Forestry and logging',
        '03 Fishing and aqua culture',
      ]
    },
    {
      ...
      'key': 'C',
      'trade': [
        '10 Manufacture of food and feed',
